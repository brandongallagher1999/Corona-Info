    ...
    render()
    {
        return(
            <DataTable>
                ...
                {
                    this.state.data.map(i => { return <CountryRow key={i.country} country={i.country} cases={i.cases} todayCases={i.todayCases}
                        deaths={i.deaths} todayDeaths={i.todayDeaths} recovered={i.recovered} active={i.active} critical={i.critical}
